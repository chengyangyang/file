 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://bean.softi.com/", wsdlLocation = "http://192.168.0.98:8888/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://bean.softi.com/", "MyWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.98:8888/ws?wsdl");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://bean.softi.com/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bean.softi.com/", "MyWebServicePort"), MyWebService.class, features);
    }
